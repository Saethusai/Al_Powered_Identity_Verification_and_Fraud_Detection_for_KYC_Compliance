...
const DocumentManipulationDisplay = ({ manipulationResult }) => {
  if (!manipulationResult) return null;
   const manipulationData = manipulationResult.analysis_details?.manipulation_result || manipulationResult;
    const { risk_level, manipulation_score, confidence, detected_issues: details = [] } = manipulationData;
