        ...
        <div className="bg-white/5 backdrop-blur-2xl rounded-2xl shadow-2xl border border-white/10 overflow-hidden">
          <div className="p-8">
            <motion.div variants={itemVariants} className="text-center mb-6">
              <div className="inline-block p-4 bg-cyan-600/30 rounded-full mb-3">
                <Shield className="w-8 h-8 text-white-500"/>
              </div>
              <h1 className="text-3xl font-bold text-white">KYC-Shield Login</h1>
              <p className="text-cyan-200/80 mt-1">Please sign in.</p>
            </motion.div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <motion.button type="submit" disabled={loading} variants={itemVariants}
                className="w-full py-3 px-4 rounded-lg font-semibold text-white bg-gradient-to-r from-cyan-400 via-cyan-600 to-cyan-600 text-black disabled:opacity-50 focus:outline-none focus:ring-4 focus:ring-blue-500/50"
